...
<form method="POST" action="/products/delete.php" onsubmit="return confirm('Product \'<?= htmlspecialchars($product->getName()) ?>\' verwijderen?');">
  <?= csrfField() ?>
  <input type="hidden" name="id" value="<?= $product->getId() ?>">
  <div style="max-width:56rem;margin:1rem auto 0;padding:0 1.5rem;">
    <button type="submit" class="btn btn-ghost" style="color:var(--destructive);font-size:0.8rem;">Product verwijderen</button>
  </div>
</form>
