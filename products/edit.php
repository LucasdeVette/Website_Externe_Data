...
<div class="max-w-4xl px-6" style="padding-top:2rem;padding-bottom:4rem;">
  ...
  <form method="POST" class="form-card">
    ...
    <div class="form-actions">
      ...
      <a href="/products/delete.php?id=<?= $product->getId() ?>" class="btn btn-outline" style="color:var(--destructive);border-color:color-mix(in srgb, var(--destructive) 30%, transparent);">Verwijderen</a>
